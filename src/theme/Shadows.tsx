...
function CreateCustomShadow(theme:Theme, color:string) : ShadowObject {
  ...
  return {
    ...
    orange: `0px 12px 14px 0px ${alpha(theme.palette.info.main, 0.3)}`,
...
export default function CustomShadows(_mode: string, theme:Theme):ShadowObject {
